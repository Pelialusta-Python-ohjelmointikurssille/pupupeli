import { setCommandList } from "./game/game.js"

export function initializeEventHandler (worker) {
    worker.onmessage = function (event) {
        if (event.data.type === 'input') {
            ...
            // runGameCommands function temporarily here
            // runGameCommands(event.data.data);
            setCommandList(event.data.data);
